...
const bubbleSort = async () => {
    ...
    /**
     * travers through the array from the end to the beginning. In each iteration of the outer loop, the largest unsorted 
     * element (maximum) gets bubbled up to its correct position.
     */
    for(let i = n - 1;i > 0;i--){
        /**
         *  iterates through the unsorted portion of the array. It performs pairwise comparisons and swaps adjacent elements 
        ...
        insertArrayToHtml(array);
        document.getElementById('status').innerHTML = 'Sorted Using BubbleSort';
};
